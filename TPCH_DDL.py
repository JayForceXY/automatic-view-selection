...
TPCH_DATABASE = dict ( lineorder=LINEORDER_ATTRIBUTES,customer=CUSTOMER_ATTRIBUTES,supplier=SUPPLIER_ATTRIBUTES,part=PART_ATTRIBUTES,date_dim=DATE_DIM_ATTRIBUTES,time_dim=TIME_DIM_ATTRIBUTES )
